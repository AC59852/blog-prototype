<template>
  <div class="about page">
    ...
    <div v-for="news in newsData" :key="news.uid" :id="'newsArticle' + news.uid">
      <h1>{{ $prismic.richTextAsPlain(news.data.title) }}</h1>
      <prismic-image :field="news.data.image" class="test" :id="'newsImage' + news.uid"/>
      <prismic-rich-text :htmlSerializer="anotherHtmlSerializer" :field="news.data.text_block_1"/>
